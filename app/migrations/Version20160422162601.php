 ...
 */
class Version20160422162601 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sylius_theme ADD screenshots LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\'');
    }
